    ...
    <footer className="bg-red-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <span className="text-white font-bold text-xl">SSF Muhimmath</span>
            </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-red-200 text-sm">Badiadka, Kasaragod District</span>
              </div>
              <div className="flex items-center space-x-2">
                <Phone className="w-4 h-4 text-yellow-300" />
                <span className="text-red-200 text-sm">+91 9876543210</span>
              </div>
              <div className="flex items-center space-x-2">
                <Mail className="w-4 h-4 text-yellow-300" />
                <span className="text-red-200 text-sm">info@muhimmath.org</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-red-800 mt-8 pt-8 text-center">
          <p className="text-red-200">&copy; 2025 SSF Muhimmath Daawa Sector. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
