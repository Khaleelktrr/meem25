      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Our events take place in the beautiful town of Badiadka, known for its rich cultural heritage
            </p>
          </motion.div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900">Badiadka, Kasaragod District</h3>
                </div>
                <p className="text-gray-600 leading-relaxed mb-6">
                  Badiadka is a culturally rich town in Kasaragod District, Kerala. The town provides the perfect backdrop for our events, with its peaceful environment and strong community support for cultural activities.
                </p>
                <div className="space-y-2 text-gray-600">
                  <p><strong>Venue:</strong> Badiadka Town Hall & Cultural Center</p>
